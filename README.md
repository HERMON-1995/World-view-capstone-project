...
**[World-view-capstone-project]** is a mobile web app built with React and Redux that uses the [Rest Countries API](https://restcountries.com/) to display detailed data on a list of countries.
